Este trabalho apresenta 7 algoritmos que operam sobre estruturas de dados conhecidas como grafos. Para cada algoritmo, iremos apresentar uma breve descrição sobre o mesmo, uma análise de sua complexidade e detalhes da implementação. Os algoritmos implementados foram:
